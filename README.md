...
- [Agent Corrupt Success: Done Claim Without Consumer-End Evidence](docs/case-studies/agent-corrupt-success-consumer-verification.md) - Agent reported work was written, but downstream never received it because proof was collected upstream of the consumer endpoint.
