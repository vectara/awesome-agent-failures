...
### Core Documentation
- [Complete Taxonomy](docs/taxonomy.md) - Detailed failure classification system
- [Contributing Guide](CONTRIBUTING.md) - How to contribute to this list
...
- [Measuring Hallucinations in RAG Systems](https://www.vectara.com/blog/measuring-hallucinations-in-rag-systems) - Introduction to Hallucination Evaluation Model (HEM)
...
### Books
- *Human-Compatible: Artificial Intelligence and the Problem of Control* by Stuart Russell ([Amazon](https://www.amazon.com/Human-Compatible-Artificial-Intelligence-Problem/dp/0525558616))
- *The Alignment Problem: Machine Learning and Human Values* by Brian Christian ([Amazon](https://www.amazon.com/Alignment-Problem-Machine-Learning-Values/dp/0393635821))
