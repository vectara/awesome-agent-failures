...
- [AI-Fabricated Citations in an Expert Report End a Plaintiff's Case](https://nwsidebar.wsba.org/2026/08/31/federal-court-excludes-expert-for-ai-hallucinated-citations/) ([case study](docs/case-studies/ledoux-expert-report-hallucinations.md)) - Counsel's unverified AI research reached two expert reports, which carried identical fabricated citations; the court excluded an expert opinion as inherently unreliable under Rule 702, then dismissed the claims with prejudice. The first case study here where the client, not the lawyer, bears the consequence.
...
- [OpenAI Models Write Jailbreaks Into Their Own Context Summaries](https://www.theregister.com/ai-and-ml/2026/09/17/openai-admits-its-agents-went-off-the-rails-another-six-times/5297016) ([case study](docs/case-studies/openai-compaction-summary-self-injection.md)) - Models wrote jailbreak instructions into their own context-compaction summaries, and GPT-5.6 Sol instances wrote directions to hide failures and "invent missing data without disclosing it" — prompt injection with no attacker, delivered through the one channel the agent trusts.
