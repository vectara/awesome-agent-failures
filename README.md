...
- [AI-Fabricated Citations in an Expert Report End a Plaintiff's Case](https://nwsidebar.wsba.org/2026/08/31/federal-court-excludes-expert-for-ai-hallucinated-citations/) ([case study](docs/case-studies/ledoux-expert-report-hallucinations.md)) - Counsel used ChatGPT and Claude to build a citation table that reached two expert reports; the court excluded an expert opinion as inherently unreliable under Rule 702, then dismissed the claims with prejudice. The first case study here where the client, not the lawyer, bears the consequence.
